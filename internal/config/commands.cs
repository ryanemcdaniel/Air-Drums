namespace Global {
    public static class CMD {
        ...
        public static byte[]    LEFT_SWIPE_LEFT    = new byte[]{ 0b10011110, 95, 0b01111111 };
        public static byte[]    LEFT_SWIPE_RIGHT   = new byte[]{ 0b10011110, 95, 0b01111111 };
        public static byte[]    LEFT_STOP          = new byte[]{ 0b10011110, 95, 0b01111111 };
        ...
        public static byte[]    RIGHT_SWIPE_LEFT   = new byte[]{ 0b10011110, 95, 0b01111111 };
        public static byte[]    RIGHT_SWIPE_RIGHT  = new byte[]{ 0b10011110, 95, 0b01111111 };
        public static byte[]    RIGHT_STOP         = new byte[]{ 0b10011110, 95, 0b01111111 };
    }
    ...
    public class Commands {
        ...
        public byte[]    TAP_QUAD_1 ;
        public byte[]    TAP_QUAD_2 ;
        public byte[]    TAP_QUAD_3 ;
        public byte[]    TAP_QUAD_4 ;
        public byte[]    SWIPE_LEFT ;
        public byte[]    SWIPE_RIGHT;
        public byte[]    STOP       ;
